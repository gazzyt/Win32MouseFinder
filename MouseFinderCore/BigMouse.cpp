...
void BigMouse::Show(HINSTANCE hInstance, HWND parent, unsigned int bitmapResource)
{
    ...
    if (m_bigMouse == 0)
    {
        ...
        m_bigMouse = CreateWindowEx(WS_EX_LAYERED | WS_EX_TOPMOST | WS_EX_TOOLWINDOW, m_wndClassName, nullptr, WS_POPUP | WS_VISIBLE, 0, 0, m_width, m_height, NULL, NULL, hInstance, NULL);
